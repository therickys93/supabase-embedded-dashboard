...
export const authGeneralSettingsSchema = z.object({
  ...
  external_anonymous_users_enabled: z
    ...
    .optional()
    .describe(
      "This will enable anonymous users to sign in to your application."
    ),
});
export type AuthGeneralSettingsSchema = z.infer<
  typeof authGeneralSettingsSchema
>;
...
export const authGoogleProviderObject = z.object({
  ...
  external_google_skip_nonce_check: z
    ...
    .optional()
    .describe(
      "Allows ID tokens with any nonce to be accepted, which is less secure."
    ),
});
